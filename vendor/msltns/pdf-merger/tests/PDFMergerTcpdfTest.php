...
class PDFMergerTcpdfTest extends TestCase
{
    /** @var string */
    ...
    public function testMergePdfAllPages()
    {
        ...
        $this->verifyFiles('results/tcpdf/result_all_pages.pdf', 'test_github_1.pdf');
    }
    ...
    public function testMergePdfSpecificPages()
    {
        ...
        $this->verifyFiles('results/tcpdf/result_specific_pages.pdf', 'test_github_1.pdf');
    }
    ...
    public function testMergePdfPagesRange()
    {
        ...
        $this->verifyFiles('results/tcpdf/result_pages_range.pdf', 'test_github_1.pdf');
    }
