...
if( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) )
{
	...
	class WC_Shipcloud_Shipping extends WC_Shipping_Method
	{
		...
		public function check_settings(){
			if( !array_key_exists( 'api_key', $this->settings ) && '' == $this->settings[ 'api_key' ] ||  array_key_exists( 'woocommerce_shipcloud_api_key', $_POST  ) && '' == $_POST[ 'woocommerce_shipcloud_api_key' ]){
