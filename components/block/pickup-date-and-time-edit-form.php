...
<div class="shipcloud__pickup_time">
    <div class="shipcloud__pickup_time--earliest">
        ...
        &lrm;
        <input type="number" class="pickup_time hour" placeholder="<?php esc_attr_e( 'h', 'woocommerce' ) ?>" name="pickup[pickup_earliest_time_hour]" min="0" max="23" step="1" pattern="([01]?[0-9]{1}|2[0-3]{1})" value="{{ data.model.get('pickup_request').getPickupTimeAsHash('earliest').hours }}" />:
        <input type="number" class="pickup_time minute" placeholder="<?php esc_attr_e( 'm', 'woocommerce' ) ?>" name="pickup[pickup_earliest_time_minute]" min="0" max="59" step="1" pattern="[0-5]{1}[0-9]{1}" value="{{ data.model.get('pickup_request').getPickupTimeAsHash('earliest').minutes }}" />
    </div>
    <div class="shipcloud__pickup_time--latest">
        ...
        &lrm;
        <input type="number" class="pickup_time hour" placeholder="<?php esc_attr_e( 'h', 'woocommerce' ) ?>" name="pickup[pickup_latest_time_hour]" min="0" max="23" step="1" pattern="([01]?[0-9]{1}|2[0-3]{1})" value="{{ data.model.get('pickup_request').getPickupTimeAsHash().hours }}" />:
        <input type="number" class="pickup_time minute" placeholder="<?php esc_attr_e( 'm', 'woocommerce' ) ?>" name="pickup[pickup_latest_time_minute]" min="0" max="59" step="1" pattern="[0-5]{1}[0-9]{1}" value="{{ data.model.get('pickup_request').getPickupTimeAsHash().minutes }}" />
    </div>
</div>
