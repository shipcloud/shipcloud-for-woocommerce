...
shipcloud.LabelForm = function (wrapperSelector) {
      ...
      selected_additional_services.forEach(function(element) {
        switch(element) {
		  ...
		  case 'angel_de_delivery_date_time':
			  var date = $('input[name="shipment[additional_services][angel_de_delivery_date_time][date]"]').val();
			  var earliest 	= $('input[name="angel_de_delivery_date_time_earliest_time_hour"]').val()
			  				+ ':' 
			  				+ $('input[name="angel_de_delivery_date_time_earliest_time_minute"]').val();
			  var latest 	= $('input[name="angel_de_delivery_date_time_latest_time_hour"]').val()
			  				+ ':' 
			  				+ $('input[name="angel_de_delivery_date_time_latest_time_minute"]').val();
			  additional_services_array.push({
				  'name': 'angel_de_delivery_date_time',
				  'properties': {
					  'date': date,
					  'time_of_day_earliest': earliest,
					  'time_of_day_latest': latest
				  }
			  });
			  break;
          ...
          case 'dhl_endorsement':
			var handling = $('select[name="shipment[additional_services][dhl_endorsement][handling]"]').val();
            additional_services_array.push({
          ...
          case 'dhl_parcel_outlet_routing':
            additional_services_array.push({
              ...
              'properties': {
                'email': $('textarea[name="shipment[additional_services][dhl_parcel_outlet_routing][email]"]').val()
              }
            });
            break;
          case 'advance_notice':
	...
	this.getPickupData  = function (pointInTime) {
		...
		var pickup_hash = {
			...
			'pickup_latest_date': $('input[name="pickup[pickup_earliest_date]"]', self.$wrapper).val(),
