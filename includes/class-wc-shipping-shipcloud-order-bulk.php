		...
		public function admin_enqueue_scripts() {
			...
			if ( in_array( $screen_id, [ 'edit-shop_order' ] ) ) {
			    ...
			    wp_localize_script(
					...
					array(
						'carriers_with_pickup_object' 	=> WC_Shipping_Shipcloud_Utils::get_carrier_providing_pickup_service()['carriers_with_pickup_object'],
						'carriers_with_pickup_request' 	=> WC_Shipping_Shipcloud_Utils::get_carrier_providing_pickup_service()['carriers_with_pickup_request']
					)
				);
